# -*- coding: utf-8 -*-
"""
Created on Sat Jul  3 17:16:03 2021
...
class STBlock(nn.Module):
    def __init__(self, N, T1, T2, K):
        ...
        #self.lstm = LSTM(1, 32, 2, 1, T2)
        #layers = math.ceil(math.log((T2 - 1)/2 + 1,2))
        #layer_channels = [1] * layers
        #self.tcn = TemporalConvNet(1, layer_channels, 3)
    ...
    def forward(self, X, A):                                                                   # B X N X 1 X T
        ...
        #X_new = self.tcn(X_new)                                                           # BN X 1 X T2
