# -*- coding: utf-8 -*-
"""
Created on Sun Jul 24 20:52:49 2022
...
def draw_cd_diagram(df_perf=None, alpha=0.05, title=None, labels=False):
    ...
    plt.savefig(os.path.join('CD', f'cd-diagram-{title}.png'),bbox_inches='tight')
...
#df_perf = pd.read_csv('AblationCORR.csv',index_col=False)
#draw_cd_diagram(df_perf=df_perf, alpha = 0.1, title='CORR', labels=True)